...
If we get next page, it means we have been able to authenticate ourselves successfully.
...
We can log in with our login and password or SID (If you don't know how to use this option, don't use it) and in Saved we can add our data for the bot to save.
