...
1. There is no file named DarkBot.jar in your bot folder, for example, because you didn't extract it from the zip archive or you renamed this file.
2. You don't have any java version installed on PC (the same solution as for the Windows cannot find javaw error - scroll up).
...
- Put your username, and your password in the new file
